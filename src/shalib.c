#ifndef LWHTTP_DONT_USE_N3Ur0t0x1c_SHALIB
#include "shalib.h"
#include <string.h>
...
int lwHTTP_CalculateSHA1(
	...
	Sha1Initialise( sha1 );
	Sha1Update( sha1, text, length );
	Sha1Finalise( sha1, (SHA1_HASH*)result );
	int ret = 0;
	return ret;
}

#endif //LWHTTP_DONT_USE_N3Ur0t0x1c_SHALIB
